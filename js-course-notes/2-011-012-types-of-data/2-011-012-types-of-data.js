...
// Названия переменных не должны повторять зарезервированные слова в языке. (error, alert, prompt, alert etc.)
...
// |===:===:===:===>
/** links:
 * (Глава из учебника про Symbol): https://learn.javascript.ru/symbol
