...
// |===:===:===:===>
/** links:
 * (Документация про методы строк): https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/String
 * (Глава учебника про методы строк): https://learn.javascript.ru/string
 * (Документация про метод trim): https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/String/Trim
 * (Документация про метод trim): https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/String/Trim
*/