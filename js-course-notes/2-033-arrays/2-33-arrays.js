...
// todo Такая конструкция работает только с массивоподобными сущностями (массив, псевдомассив (коллекция), строка, map, set или какие-то определённые элементы со страницы). Но на объекты применить не получится!
 ...
 * (Ссылка на шпаргалку по объектам и массивам): https://drive.google.com/open?id=17D4THU5-UJtzihybKVjSDHeX67pz3xLR
*/