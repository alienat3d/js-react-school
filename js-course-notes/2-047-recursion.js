...
// |===:===:===:===>
/** links:
 * (Документация по isArray): https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Array/isArray
 * (Документация по Object.values): https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Object/values
 * (Полезная статья про рекурсию): https://ru.hexlet.io/courses/introduction_to_programming/lessons/recursion/theory_unit
*/