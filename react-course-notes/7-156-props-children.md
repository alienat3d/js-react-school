...
? Часто в разработке бывает так, что есть одна обёртка компонента, но мы не знаем, что у неё будет внутри: сайдбар, футер, корзина товаров или что-то другое. А если этот компонент будет на разных страницах — то нам бы совсем не хотелось его каждый раз создавать. Ведь может случиться, что понадобится сотня компонентов, отличающихся одним заголовком, например. Чтобы оптимизировать подобные случаи, нам помогут эти приёмы. Это максимально полезно особенно в больших приложениях.
