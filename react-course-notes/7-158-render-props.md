...
? Принять к сведению: если компонент не знает что в нём будет находиться, то используем либо props.children, либо props.render. Так мы значительно сократим и количество кода и компонентов.
