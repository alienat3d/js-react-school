...
? "CSSinJS" технология, это использование CSS-кода прямо внутри JS-компонентов. Это довольно популярный подход, активно
используется, поэтому важно его рассмотреть.
...
1) Инкапсуляция стилей, теперь нет пересечений, потому, что даже названия классов генерируются случайным образом;
