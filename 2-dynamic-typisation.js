...
// Самый простой и часто используемый пример использования — формирование URL.
console.log("https://google.com/catalogue/" + 5);
// Также можем получать какие-то картинки или формировать стили при помощи JS.
...
console.log(5 + +'5');
// 3) Специальными методами, например parseInt().
...
console.log(typeof (Boolean('5'))); // Boolean() метод превращает любой тип данных в булевский\логический.
