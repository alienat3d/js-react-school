...
// Для этого у нас есть timestamps. Их можно использовать как напрямую, так и использовать преобразовывание динамически типов данных и поставить унарный плюс перед объектов Date.
