...
/* harmony import */ var _modules_classes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/classes.js */ "./src/js/modules/classes.js");
...
Object(_modules_classes_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
const classesFunc = () => {
  ...
  new MenuCard('img/tabs/vegy.jpg', 'vegy', 'Меню “Фитнес”', 'Меню “Фитнес” - это новый подход к приготовлению блюд: больше свежих овощей и фруктов. Продукт активных и здоровых людей. Это абсолютно новый продукт с оптимальной ценой и высоким качеством!', 7.5, '.menu .container').render(); // 1.5 Создадим ещё две подобные карточки:
