...
// * *==* *** *==* * //
// * 8.0.0 Тестируем получение данных при помощи методом библиотеки Axios.
// ? 8.0.1 Кстати, как мы видим, принципиальное отличие от получения данных при помощи fetch(), что axios даёт нам более подробный ответ и данные уже удобно лежат в JS-объект формате в свойстве data.
// ? 8.0.2 При этом и обработки ошибок, авто-конвертация в нужный тип и прочие плюшки делаются без нашего участия и без необходимости писать этот функционал.
