...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getData)('http://localhost:3000/menu').then(data => data.forEach(({
    img,
    altimg,
    title,
    descr,
...
function modal(triggerSelector, modalSelector, modalTimerID) {
  ...
  modalTriggers.forEach(trigger => trigger.addEventListener('click', () => openingModal(modalSelector, modalTimerID)));
...
(__webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js").polyfill)(); // - commonJS версия подключения
 // - очень удобное подключение NPM-пакетов напрямую из папки node_modules в наш проект
